...
int main(int argc, char *argv[])
{
    ...
    bool has_gemm = false, has_brgemm = false, has_matmul = false, has_unary = false, tensor_operations = false, shared_tensor_operations = false, opt_tensor_operations = false;
