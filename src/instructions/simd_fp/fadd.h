#ifndef MINI_JIT_INSTRUCTIONS_SIMD_FP_FADD_H
#define MINI_JIT_INSTRUCTIONS_SIMD_FP_FADD_H
...
namespace mini_jit
{
    namespace instructions
    {
        ...
        {
            /**
             * @brief Generates an FADD (vector) instruction.
             *
            ...
            /**
             * @brief Generates an FADD (scalar) instruction.
             *
             * @param reg_dest destination register.
             * @param reg_src1 first source register.
             * @param reg_src2 second source register.
...
#endif // MINI_JIT_INSTRUCTIONS_SIMD_FP_FADD_H