...
TEST_CASE( "Tests the v1_matmul_16_6_1 microkernel function", "[v1_matmul_16_6_1]" )
{
    const int M = 16;
    const int N = 6;
    const int K = 1;
...
TEST_CASE( "Tests the v2_matmul_16_6_1 microkernel function", "[v2_matmul_16_6_1]" )
{
    const int M = 16;
    const int N = 6;
    const int K = 1;
...
TEST_CASE( "Tests the v3_matmul_16_6_1 microkernel function", "[v3_matmul_16_6_1]" )
{
    const int M = 16;
    const int N = 6;
    const int K = 1;
