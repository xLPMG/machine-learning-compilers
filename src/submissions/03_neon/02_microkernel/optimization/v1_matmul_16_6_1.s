    .text
    .type v1_matmul_16_6_1, %function
    .global v1_matmul_16_6_1
    /*
    * Computes C+=AB for three matrices
    * Loads matrix A and C completely and for matrix B
    * 2 times 3 columns.
    *
...
v1_matmul_16_6_1:
    ...
    /*
     * Copy the leading dimensions of A, B, C (for loop)
     */
    mov x19, x3
    mov x20, x4
    mov x21, x5
    ...
    ldr s28, [x6]           // Column B(4)
    add x6, x6, x4

    ldr s29, [x6]           // Column B(5)

    /*
     * Multiply and accumulate (2 / 2)
     */
