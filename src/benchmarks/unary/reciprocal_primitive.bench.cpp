#include <random>
#include <chrono>
#include "reciprocal_primitive.bench.h"
#include "benchmarks/Benchmark.h"
#include "kernels/unary/reciprocal_primitive.h"
#include "Kernel.h"
#include "Unary.h"

mini_jit::benchmarks::ReciprocalPrimitiveBench::ReciprocalPrimitiveBench(double runTime,
                                                                         uint32_t m,
...
void mini_jit::benchmarks::ReciprocalPrimitiveBench::run()
{
    ...
    mini_jit::kernels::unary::reciprocal(l_kernel, m_M, m_N);
