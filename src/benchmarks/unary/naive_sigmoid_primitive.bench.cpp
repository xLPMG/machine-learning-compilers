...
mini_jit::benchmarks::NaiveSigmoidPrimitiveBench::NaiveSigmoidPrimitiveBench(double   runTime,
                                                                           uint32_t m,
...
void mini_jit::benchmarks::NaiveSigmoidPrimitiveBench::run()
{
