#include <random>
#include <chrono>
#include "relu_trans_primitive.bench.h"
#include "benchmarks/Benchmark.h"
#include "kernels/unary/relu_trans_primitive.h"
#include "Kernel.h"
#include "Unary.h"

mini_jit::benchmarks::Relu_trans_primitive_bench::Relu_trans_primitive_bench(double runTime,
                                                                             uint32_t m,
...
void mini_jit::benchmarks::Relu_trans_primitive_bench::run()
{
