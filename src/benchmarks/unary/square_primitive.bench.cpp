#include <random>
#include <chrono>
#include "square_primitive.bench.h"
#include "benchmarks/Benchmark.h"
#include "kernels/unary/square_primitive.h"
#include "Kernel.h"
#include "Unary.h"

mini_jit::benchmarks::Square_primitive_bench::Square_primitive_bench(double runTime,
                                                                        uint32_t m,
...
void mini_jit::benchmarks::Square_primitive_bench::run()
{
    ...
    mini_jit::kernels::unary::square(l_kernel, m_M, m_N);
