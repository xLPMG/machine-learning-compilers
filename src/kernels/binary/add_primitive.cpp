                                    ...
                                    u_int32_t         n)
{
    ...
    if (mLoopIterations > 0)
    {
        ...
        kernel.add_instr({
            ...
            faddVec(v8, v0, v4, s4),
            faddVec(v9, v1, v5, s4),
            faddVec(v10, v2, v6, s4),
            faddVec(v11, v3, v7, s4),
