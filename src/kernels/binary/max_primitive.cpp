...
void mini_jit::kernels::binary::max(mini_jit::Kernel &kernel,
                                    u_int32_t m,
                                    u_int32_t n)
{
    // Inputs:
    ...
    if (mLoopRemainder > 0)
    {
        ...
        case 8:
            kernel.add_instr({
                ...
                simd_fp::fmaxVec(v4, v0, v2, s4),
                simd_fp::fmaxVec(v5, v1, v3, s4),
        ...
        case 11:
            kernel.add_instr({
                ...
                simd_fp::fmaxScalar(v11, v9, v10, s),
        ...
        case 15:
            kernel.add_instr({
                ...
                simd_fp::fmaxScalar(v14, v12, v13, s),
