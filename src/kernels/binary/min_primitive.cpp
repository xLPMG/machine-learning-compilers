...
#include <mlc/kernels/binary/min_primitive.h>
                                    ...
                                    u_int32_t         n)
{
    ...
    if (mLoopIterations > 0)
    {
        ...
        kernel.add_instr({
            ...
            fminVec(v8, v0, v4, s4),
            fminVec(v9, v1, v5, s4),
            fminVec(v10, v2, v6, s4),
            fminVec(v11, v3, v7, s4),
