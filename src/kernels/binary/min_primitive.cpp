...
void mini_jit::kernels::binary::min(mini_jit::Kernel &kernel,
                                    u_int32_t m,
                                    u_int32_t n)
{
    // Inputs:
    ...
    if (mLoopIterations > 0)
    {
        ...
        kernel.add_instr({
            ...
            // compute C = min(A, B)
            simd_fp::fminVec(v8, v0, v4, s4),
            simd_fp::fminVec(v9, v1, v5, s4),
            simd_fp::fminVec(v10, v2, v6, s4),
            simd_fp::fminVec(v11, v3, v7, s4),
    ...
    if (mLoopRemainder > 0)
    {
        ...
        case 8:
            kernel.add_instr({
                ...
                simd_fp::fminVec(v4, v0, v2, s4),
                simd_fp::fminVec(v5, v1, v3, s4),
        ...
        case 11:
            kernel.add_instr({
                ...
                simd_fp::fminScalar(v11, v9, v10, s),
        ...
        case 15:
            kernel.add_instr({
                ...
                simd_fp::fminScalar(v14, v12, v13, s),
    ...
    kernel.write("max_primitive.bin");
    kernel.set_kernel();
}