...
#include <mlc/kernels/binary/sub_primitive.h>
                                    ...
                                    u_int32_t         n)
{
    ...
    if (mLoopIterations > 0)
    {
        ...
        kernel.add_instr({
            ...
            fsubVec(v8, v0, v4, s4),
            fsubVec(v9, v1, v5, s4),
            fsubVec(v10, v2, v6, s4),
            fsubVec(v11, v3, v7, s4),
