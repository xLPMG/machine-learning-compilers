...
#include <mlc/kernels/unary/reciprocal_trans_primitive.h>
...
void mini_jit::kernels::unary::reciprocal_trans(mini_jit::Kernel& kernel,
                                                int               m,
                                                int               n)
{
    // Prepare the kernel
    ...
    if (nLoopIterations > 0)
    {
        ...
        {
            internal_subkernels::reciprocalM4N4(kernel, mLoopIterations);
        }
        ...
        if (mLoopRemainder > 0)
        {
            ...
            {
            case 1:
                internal_subkernels::reciprocalM1N4(kernel);
                break;
            case 2:
                internal_subkernels::reciprocalM2N4(kernel);
                break;
            case 3:
                internal_subkernels::reciprocalM3N4(kernel);
                break;
            default:
                break;
            }
        ...
        kernel.add_instr({// Restore positions
                          mov(x4, x0),
                          mov(x5, x1),
    ...
    if (nLoopRemainder > 0)
    {
        if (mLoopIterations)
        {
            ...
            {
            case 1:
                internal_subkernels::reciprocalM4N1(kernel, mLoopIterations);
                break;
            case 2:
                internal_subkernels::reciprocalM4N2(kernel, mLoopIterations);
                break;
            case 3:
                internal_subkernels::reciprocalM4N3(kernel, mLoopIterations);
                break;
            default:
                break;
            }
        ...
        if (mLoopRemainder > 0)
        {
            ...
            case 1:
                if (nLoopRemainder == 1)
                {
                    internal_subkernels::reciprocalM1N1(kernel);
                }
                else if (nLoopRemainder == 2)
                {
                    internal_subkernels::reciprocalM1N2(kernel);
                }
                else if (nLoopRemainder == 3)
                {
                    internal_subkernels::reciprocalM1N3(kernel);
                }
                break;
            case 2:
                if (nLoopRemainder == 1)
                {
                    internal_subkernels::reciprocalM2N1(kernel);
                }
                else if (nLoopRemainder == 2)
                {
                    internal_subkernels::reciprocalM2N2(kernel);
                }
                else if (nLoopRemainder == 3)
                {
                    internal_subkernels::reciprocalM2N3(kernel);
                }
                break;
            case 3:
                if (nLoopRemainder == 1)
                {
                    internal_subkernels::reciprocalM3N1(kernel);
                }
                else if (nLoopRemainder == 2)
                {
                    internal_subkernels::reciprocalM3N2(kernel);
                }
                else if (nLoopRemainder == 3)
                {
                    internal_subkernels::reciprocalM3N3(kernel);
                }
                break;
            default:
                break;
    ...
    kernel.write("reciprocal_trans_primitive.bin");
    kernel.set_kernel();
}

void mini_jit::kernels::unary::internal::reciprocalM4N4(mini_jit::Kernel& kernel,
                                                        int               mLoopIterations)
{
    ...
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM3N4(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
                      ...
                      frecpeVec(v16, v14, s4),
                      frecpsVec(v17, v14, v16, s4),
                      fmulVec(v14, v16, v17, s4),

                      frecpeVec(v16, v15, s4),
                      frecpsVec(v17, v15, v16, s4),
                      fmulVec(v15, v16, v17, s4),

                      frecpeVec(v16, v18, s2),
                      frecpsVec(v17, v18, v16, s2),
                      fmulVec(v18, v16, v17, s2),

                      frecpeVec(v16, v19, s2),
                      frecpsVec(v17, v19, v16, s2),
                      fmulVec(v19, v16, v17, s2),
...
void mini_jit::kernels::unary::internal::reciprocalM2N4(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
                      ...
                      frecpeVec(v16, v8, s4),
                      frecpsVec(v17, v8, v16, s4),
                      fmulVec(v8, v16, v17, s4),

                      frecpeVec(v16, v9, s4),
                      frecpsVec(v17, v9, v16, s4),
                      fmulVec(v9, v16, v17, s4),
...
void mini_jit::kernels::unary::internal::reciprocalM4N3(mini_jit::Kernel& kernel,
                                                        int               mLoopIterations)
{
    kernel.add_instr(mov(x6, mLoopIterations));
    ...
    kernel.add_instr({// working pointer for A and B
                      ...
                      frecpeVec(v16, v0, s2),
                      frecpsVec(v17, v0, v16, s2),
                      fmulVec(v0, v16, v17, s2),

                      frecpeVec(v16, v1, s2),
                      frecpsVec(v17, v1, v16, s2),
                      fmulVec(v1, v16, v17, s2),

                      frecpeVec(v16, v2, s2),
                      frecpsVec(v17, v2, v16, s2),
                      fmulVec(v2, v16, v17, s2),

                      frecpeVec(v16, v3, s2),
                      frecpsVec(v17, v3, v16, s2),
                      fmulVec(v3, v16, v17, s2),

                      frecpeScalar(v16, v4, s),
                      frecpsScalar(v17, v4, v16, s),
                      fmulScalar(v4, v16, v17, s),

                      frecpeScalar(v16, v5, s),
                      frecpsScalar(v17, v5, v16, s),
                      fmulScalar(v5, v16, v17, s),

                      frecpeScalar(v16, v6, s),
                      frecpsScalar(v17, v6, v16, s),
                      fmulScalar(v6, v16, v17, s),

                      frecpeScalar(v16, v7, s),
                      frecpsScalar(v17, v7, v16, s),
                      fmulScalar(v7, v16, v17, s),
...
void mini_jit::kernels::unary::internal::reciprocalM4N2(mini_jit::Kernel& kernel,
                                                        int               mLoopIterations)
{
    kernel.add_instr(mov(x6, mLoopIterations));
...
void mini_jit::kernels::unary::internal::reciprocalM4N1(mini_jit::Kernel& kernel,
                                                        int               mLoopIterations)
{
    kernel.add_instr(mov(x6, mLoopIterations));
...
void mini_jit::kernels::unary::internal::reciprocalM3N3(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM3N2(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM3N1(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM2N3(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM1N3(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM2N2(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM2N1(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM1N2(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::reciprocalM1N1(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
