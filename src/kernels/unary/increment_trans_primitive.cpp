...
#include <mlc/kernels/unary/increment_trans_primitive.h>
...
void mini_jit::kernels::unary::increment_trans(mini_jit::Kernel& kernel,
                                               int               m,
                                               int               n)
{
    // Prepare the kernel
    ...
    if (nLoopIterations > 0)
    {
        ...
        {
            internal_subkernels::incrementM4N4(kernel, mLoopIterations);
        }
        ...
        if (mLoopRemainder > 0)
        {
            ...
            {
            case 1:
                internal_subkernels::incrementM1N4(kernel);
                break;
            case 2:
                internal_subkernels::incrementM2N4(kernel);
                break;
            case 3:
                internal_subkernels::incrementM3N4(kernel);
                break;
            default:
                break;
            }
    ...
    if (nLoopRemainder > 0)
    {
        if (mLoopIterations)
        {
            ...
            {
            case 1:
                internal_subkernels::incrementM4N1(kernel, mLoopIterations);
                break;
            case 2:
                internal_subkernels::incrementM4N2(kernel, mLoopIterations);
                break;
            case 3:
                internal_subkernels::incrementM4N3(kernel, mLoopIterations);
                break;
            default:
                break;
            }
        ...
        if (mLoopRemainder > 0)
        {
            ...
            case 1:
                if (nLoopRemainder == 1)
                {
                    internal_subkernels::incrementM1N1(kernel);
                }
                else if (nLoopRemainder == 2)
                {
                    internal_subkernels::incrementM1N2(kernel);
                }
                else if (nLoopRemainder == 3)
                {
                    internal_subkernels::incrementM1N3(kernel);
                }
                break;
            case 2:
                if (nLoopRemainder == 1)
                {
                    internal_subkernels::incrementM2N1(kernel);
                }
                else if (nLoopRemainder == 2)
                {
                    internal_subkernels::incrementM2N2(kernel);
                }
                else if (nLoopRemainder == 3)
                {
                    internal_subkernels::incrementM2N3(kernel);
                }
                break;
            case 3:
                if (nLoopRemainder == 1)
                {
                    internal_subkernels::incrementM3N1(kernel);
                }
                else if (nLoopRemainder == 2)
                {
                    internal_subkernels::incrementM3N2(kernel);
                }
                else if (nLoopRemainder == 3)
                {
                    internal_subkernels::incrementM3N3(kernel);
                }
                break;
            default:
                break;
    ...
    kernel.write("increment_trans_primitive.bin");
    kernel.set_kernel();
}

void mini_jit::kernels::unary::internal::incrementM4N4(mini_jit::Kernel& kernel,
                                                       int               mLoopIterations)
{
    ...
    kernel.add_instr({// working pointer for A and B
                      ...
                      // Increment values
                      faddVec(v8, v8, v20, s4),
                      faddVec(v9, v9, v20, s4),
                      faddVec(v10, v10, v20, s4),
                      faddVec(v11, v11, v20, s4),
...
void mini_jit::kernels::unary::internal::incrementM3N4(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM2N4(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM1N4(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
                      ...
                      // Increment values
                      faddVec(v6, v6, v20, s4),

                      // Store 1x4 Block of B
                      str(v6, x8, 0, q)});
}

void mini_jit::kernels::unary::internal::incrementM4N3(mini_jit::Kernel& kernel,
                                                       int               mLoopIterations)
{
    kernel.add_instr(mov(x6, mLoopIterations));
...
void mini_jit::kernels::unary::internal::incrementM4N2(mini_jit::Kernel& kernel,
                                                       int               mLoopIterations)
{
    kernel.add_instr(mov(x6, mLoopIterations));
...
void mini_jit::kernels::unary::internal::incrementM4N1(mini_jit::Kernel& kernel,
                                                       int               mLoopIterations)
{
    kernel.add_instr(mov(x6, mLoopIterations));
...
void mini_jit::kernels::unary::internal::incrementM3N3(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM3N2(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM3N1(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM2N3(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM1N3(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM2N2(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM2N1(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM1N2(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
...
void mini_jit::kernels::unary::internal::incrementM1N1(mini_jit::Kernel& kernel)
{
    kernel.add_instr({// working pointer for A and B
                      mov(x7, x4),
                      mov(x8, x5),
