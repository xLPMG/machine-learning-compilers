...
#include <mlc/kernels/matmul/subkernels/matmul_m_1_k.h>
...
void mini_jit::kernels::matmul::subkernels::matmul_m_1_k(mini_jit::Kernel& kernel,
                                                         int               m,
                                                         int               k)
{
    // Prepare the kernel
    ...
    {
        mini_jit::kernels::matmul::subkernels::internal::generateM16N1Loop(kernel, mLoopIterations, k);
    }
    ...
    if (mLoopRemainder > 0)
    {
        ...
        {
        case 1:
            mini_jit::kernels::matmul::subkernels::internal::generateM1N1Loop(kernel);
            break;
        case 2:
            mini_jit::kernels::matmul::subkernels::internal::generateM2N1Loop(kernel);
            break;
        case 3:
            mini_jit::kernels::matmul::subkernels::internal::generateM3N1Loop(kernel);
            break;
        case 4:
            mini_jit::kernels::matmul::subkernels::internal::generateM4N1Loop(kernel);
            break;
        case 5:
            mini_jit::kernels::matmul::subkernels::internal::generateM5N1Loop(kernel);
            break;
        case 6:
            mini_jit::kernels::matmul::subkernels::internal::generateM6N1Loop(kernel);
            break;
        case 7:
            mini_jit::kernels::matmul::subkernels::internal::generateM7N1Loop(kernel);
            break;
        case 8:
            mini_jit::kernels::matmul::subkernels::internal::generateM8N1Loop(kernel);
            break;
        case 9:
            mini_jit::kernels::matmul::subkernels::internal::generateM9N1Loop(kernel);
            break;
        case 10:
            mini_jit::kernels::matmul::subkernels::internal::generateM10N1Loop(kernel);
            break;
        case 11:
            mini_jit::kernels::matmul::subkernels::internal::generateM11N1Loop(kernel);
            break;
        case 12:
            mini_jit::kernels::matmul::subkernels::internal::generateM12N1Loop(kernel);
            break;
        case 13:
            mini_jit::kernels::matmul::subkernels::internal::generateM13N1Loop(kernel);
            break;
        case 14:
            mini_jit::kernels::matmul::subkernels::internal::generateM14N1Loop(kernel);
            break;
        case 15:
            mini_jit::kernels::matmul::subkernels::internal::generateM15N1Loop(kernel);
            break;
        default:
            break;
        }
...
void mini_jit::kernels::matmul::subkernels::internal::generateM16N1Loop(mini_jit::Kernel& kernel,
                                                                        int               mLoopIterations,
                                                                        int               k)
{
    // prepare the kernel
    ...
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m16n1_loop");
    ...
    int l_mLoopInstrCount = kernel.getInstrCountFromLabel("m16n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x11, -l_mLoopInstrCount * 4));
    // END M_LOOP
}

void mini_jit::kernels::matmul::subkernels::internal::generateM1N1Loop(mini_jit::Kernel& kernel)
{
...
void mini_jit::kernels::matmul::subkernels::internal::generateM2N1Loop(mini_jit::Kernel& kernel)
{
...
void mini_jit::kernels::matmul::subkernels::internal::generateM3N1Loop(mini_jit::Kernel& kernel)
{
...
void mini_jit::kernels::matmul::subkernels::internal::generateM4N1Loop(mini_jit::Kernel& kernel)
{
...
void mini_jit::kernels::matmul::subkernels::internal::generateM5N1Loop(mini_jit::Kernel& kernel)
{
...
void mini_jit::kernels::matmul::subkernels::internal::generateM6N1Loop(mini_jit::Kernel& kernel)
{
...
void mini_jit::kernels::matmul::subkernels::internal::generateM7N1Loop(mini_jit::Kernel& kernel)
{
...
void mini_jit::kernels::matmul::subkernels::internal::generateM8N1Loop(mini_jit::Kernel& kernel)
{
    // Load Matrix C
    kernel.add_instr(base::mov(gpr_t::x12, gpr_t::x10));
    // first column
...
void mini_jit::kernels::matmul::subkernels::internal::generateM9N1Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m9n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM10N1Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m10n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM11N1Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m11n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM12N1Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m12n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM13N1Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m13n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM14N1Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m14n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM15N1Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m15n1_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
