                                                         ...
                                                         int               k)
{
    ...
    {
        mini_jit::kernels::matmul::subkernels::internal::generateM16N2Loop(kernel, mLoopIterations, k);
    }
    ...
    if (mLoopRemainder > 0)
    {
        ...
        {
        case 1:
            mini_jit::kernels::matmul::subkernels::internal::generateM1N2Loop(kernel);
            break;
        case 2:
            mini_jit::kernels::matmul::subkernels::internal::generateM2N2Loop(kernel);
            break;
        case 3:
            mini_jit::kernels::matmul::subkernels::internal::generateM3N2Loop(kernel);
            break;
        case 4:
            mini_jit::kernels::matmul::subkernels::internal::generateM4N2Loop(kernel);
            break;
        case 5:
            mini_jit::kernels::matmul::subkernels::internal::generateM5N2Loop(kernel);
            break;
        case 6:
            mini_jit::kernels::matmul::subkernels::internal::generateM6N2Loop(kernel);
            break;
        case 7:
            mini_jit::kernels::matmul::subkernels::internal::generateM7N2Loop(kernel);
            break;
        case 8:
            mini_jit::kernels::matmul::subkernels::internal::generateM8N2Loop(kernel);
            break;
        case 9:
            mini_jit::kernels::matmul::subkernels::internal::generateM9N2Loop(kernel);
            break;
        case 10:
            mini_jit::kernels::matmul::subkernels::internal::generateM10N2Loop(kernel);
            break;
        case 11:
            mini_jit::kernels::matmul::subkernels::internal::generateM11N2Loop(kernel);
            break;
        case 12:
            mini_jit::kernels::matmul::subkernels::internal::generateM12N2Loop(kernel);
            break;
        case 13:
            mini_jit::kernels::matmul::subkernels::internal::generateM13N2Loop(kernel);
            break;
        case 14:
            mini_jit::kernels::matmul::subkernels::internal::generateM14N2Loop(kernel);
            break;
        case 15:
            mini_jit::kernels::matmul::subkernels::internal::generateM15N2Loop(kernel);
            break;
        default:
            break;
        }
                                                                        ...
                                                                        int               k)
{
    ...
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m16n2_loop");
    ...
    int l_mLoopInstrCount = kernel.getInstrCountFromLabel("m16n2_loop");
...
void mini_jit::kernels::matmul::subkernels::internal::generateM1N2Loop(mini_jit::Kernel& kernel)
{
    ...
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m1n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM2N2Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m2n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM3N2Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m3n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM4N2Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m4n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM5N2Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m5n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM6N2Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m6n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM7N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m7n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM8N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // END K_LOOP
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m8n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM9N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m9n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM10N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m10n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM11N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m11n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM12N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m12n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM13N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m13n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM14N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m14n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM15N2Loop(mini_jit::Kernel& kernel)
{
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m15n2_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
