...
#include <mlc/kernels/matmul/subkernels/matmul_m_4_k.h>
...
void mini_jit::kernels::matmul::subkernels::matmul_m_4_k(mini_jit::Kernel& kernel,
                                                         int               m,
                                                         int               k)
{
    // Prepare the kernel
...
void mini_jit::kernels::matmul::subkernels::internal::generateM16N4Loop(mini_jit::Kernel& kernel,
                                                                        int               mLoopIterations,
                                                                        int               k)
{
    // prepare the kernel
    ...
    // fourth column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v12, simd_fp_t::v13, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v14, simd_fp_t::v15, gpr_t::x12, 32, neon_size_spec_t::q));
    ...
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m16n4_loop");
    ...
    // fourth column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::stp(simd_fp_t::v12, simd_fp_t::v13, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::stp(simd_fp_t::v14, simd_fp_t::v15, gpr_t::x12, 32, neon_size_spec_t::q));
    ...
    int l_mLoopInstrCount = kernel.getInstrCountFromLabel("m16n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x11, -l_mLoopInstrCount * 4));
    // END M_LOOP
}

void mini_jit::kernels::matmul::subkernels::internal::generateM1N4Loop(mini_jit::Kernel& kernel)
{
    ...
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m1n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM2N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m2n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM3N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::ldrPost(simd_fp_t::v6, gpr_t::x24, 8, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v7, gpr_t::x24, 0, neon_size_spec_t::s));

    // case_3_k_loop:
    kernel.add_label("k_m3n4_loop");
    ...
    kernel.add_instr(base::add(gpr_t::x16, gpr_t::x16, gpr_t::x4, 0, 0));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v29, gpr_t::x16, 0, neon_size_spec_t::s));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v6, simd_fp_t::v24, simd_fp_t::v29, arr_spec_t::s2));
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    //     // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m3n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::strPost(simd_fp_t::v6, gpr_t::x24, 8, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::str(simd_fp_t::v7, gpr_t::x24, 0, neon_size_spec_t::s));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM4N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m4n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM5N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m5n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM6N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    // check if loop counter is zero
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m6n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM7N4Loop(mini_jit::Kernel& kernel)
{
    // LOAD MATRIX C (7 values)
    kernel.add_instr(base::mov(gpr_t::x12, gpr_t::x10));
    // first column
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v0, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v1, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v2, gpr_t::x24, 24, neon_size_spec_t::s));
    // second column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v3, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v4, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v5, gpr_t::x24, 24, neon_size_spec_t::s));
    // third column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v6, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v7, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v8, gpr_t::x24, 24, neon_size_spec_t::s));
    // fourth column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v9, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v10, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v11, gpr_t::x24, 24, neon_size_spec_t::s));

    // case_7_k_loop:
    kernel.add_label("k_m7n4_loop");
    // load column of A (7 values)
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x15));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v24, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v25, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v26, gpr_t::x24, 24, neon_size_spec_t::s));
    // B: COLUMN 0
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v29, gpr_t::x16, 0, neon_size_spec_t::s));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v0, simd_fp_t::v24, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v1, simd_fp_t::v25, simd_fp_t::v29, arr_spec_t::s2));
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m7n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    // first column
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::str(simd_fp_t::v0, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v1, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::str(simd_fp_t::v2, gpr_t::x24, 24, neon_size_spec_t::s));
    // second column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::str(simd_fp_t::v3, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v4, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::str(simd_fp_t::v5, gpr_t::x24, 24, neon_size_spec_t::s));
    // third column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::str(simd_fp_t::v6, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v7, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::str(simd_fp_t::v8, gpr_t::x24, 24, neon_size_spec_t::s));
    // fourth column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(base::mov(gpr_t::x24, gpr_t::x12));
    kernel.add_instr(simd_fp::str(simd_fp_t::v9, gpr_t::x24, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v10, gpr_t::x24, 16, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::str(simd_fp_t::v11, gpr_t::x24, 24, neon_size_spec_t::s));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM8N4Loop(mini_jit::Kernel& kernel)
{
    // Load Matrix C
    kernel.add_instr(base::mov(gpr_t::x12, gpr_t::x10));
    // first column
    ...
    // END K_LOOP
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m8n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
...
void mini_jit::kernels::matmul::subkernels::internal::generateM9N4Loop(mini_jit::Kernel& kernel)
{
    ...
    // fourth column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::s));

    // case_9_k_loop:
    kernel.add_label("k_m9n4_loop");
    ...
    kernel.add_instr(base::add(gpr_t::x16, gpr_t::x16, gpr_t::x4, 0, 0));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v29, gpr_t::x16, 0, neon_size_spec_t::s));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v15, simd_fp_t::v24, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v16, simd_fp_t::v25, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmadd(simd_fp_t::v17, simd_fp_t::v26, simd_fp_t::v29, simd_fp_t::v17, neon_size_spec_t::s));
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m9n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    // fourth column
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::stp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::s));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM10N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::d));

    // case_10_k_loop:
    kernel.add_label("k_m10n4_loop");
    ...
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v15, simd_fp_t::v24, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v16, simd_fp_t::v25, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v17, simd_fp_t::v26, simd_fp_t::v29, arr_spec_t::s2));
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m10n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::stp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::d));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM11N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v18, gpr_t::x12, 40, neon_size_spec_t::s));

    // case_11_k_loop:
    kernel.add_label("k_m11n4_loop");
    ...
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v16, simd_fp_t::v25, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v17, simd_fp_t::v26, simd_fp_t::v29, arr_spec_t::s2));
    kernel.add_instr(simd_fp::fmadd(simd_fp_t::v18, simd_fp_t::v27, simd_fp_t::v29, simd_fp_t::v18, neon_size_spec_t::s));
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m11n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    kernel.add_instr(simd_fp::stp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::str(simd_fp_t::v18, gpr_t::x12, 40, neon_size_spec_t::s));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM12N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));

    // case_12_k_loop:
    kernel.add_label("k_m12n4_loop");
    ...
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v15, simd_fp_t::v24, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v16, simd_fp_t::v25, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v17, simd_fp_t::v26, simd_fp_t::v29, arr_spec_t::s4));
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m12n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    kernel.add_instr(base::add(gpr_t::x12, gpr_t::x12, gpr_t::x5, 0, 0));
    kernel.add_instr(simd_fp::stp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM13N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v18, gpr_t::x12, 48, neon_size_spec_t::s));

    // case_13_k_loop:
    kernel.add_label("k_m13n4_loop");
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m13n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    kernel.add_instr(simd_fp::stp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v18, gpr_t::x12, 48, neon_size_spec_t::s));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM14N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(simd_fp::ldp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v18, gpr_t::x12, 48, neon_size_spec_t::d));

    // case_14_k_loop:
    kernel.add_label("k_m14n4_loop");
    ...
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v16, simd_fp_t::v25, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v17, simd_fp_t::v26, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v18, simd_fp_t::v27, simd_fp_t::v29, arr_spec_t::s2));
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m14n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    kernel.add_instr(simd_fp::stp(simd_fp_t::v15, simd_fp_t::v16, gpr_t::x12, 0, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v18, gpr_t::x12, 48, neon_size_spec_t::d));
}

void mini_jit::kernels::matmul::subkernels::internal::generateM15N4Loop(mini_jit::Kernel& kernel)
{
    ...
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v18, gpr_t::x12, 48, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::ldr(simd_fp_t::v19, gpr_t::x12, 56, neon_size_spec_t::s));

    // case_15_k_loop:
    kernel.add_label("k_m15n4_loop");
    ...
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v17, simd_fp_t::v26, simd_fp_t::v29, arr_spec_t::s4));
    kernel.add_instr(simd_fp::fmlaElem(simd_fp_t::v18, simd_fp_t::v27, simd_fp_t::v29, arr_spec_t::s2));
    kernel.add_instr(simd_fp::fmadd(simd_fp_t::v19, simd_fp_t::v28, simd_fp_t::v29, simd_fp_t::v19, neon_size_spec_t::s));
    ...
    // decrement loop counter
    kernel.add_instr(base::sub(gpr_t::x14, gpr_t::x14, 1, 0));
    int l_kLoopInstrCount = kernel.getInstrCountFromLabel("k_m15n4_loop");
    kernel.add_instr(base::cbnz(gpr_t::x14, -l_kLoopInstrCount * 4));
    ...
    kernel.add_instr(simd_fp::str(simd_fp_t::v17, gpr_t::x12, 32, neon_size_spec_t::q));
    kernel.add_instr(simd_fp::str(simd_fp_t::v18, gpr_t::x12, 48, neon_size_spec_t::d));
    kernel.add_instr(simd_fp::str(simd_fp_t::v19, gpr_t::x12, 56, neon_size_spec_t::s));
}
