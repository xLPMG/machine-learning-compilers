...
namespace mini_jit
{
    ...
    inline const std::string to_string(ptype_t p)
    {
        ...
        case ptype_t::sigmoid_interp:
            return "sigmoid_interpolation";
        case ptype_t::sigmoid_taylor:
            return "sigmoid_taylor";
        case ptype_t::none:
            return "none";
        default:
            return "unknown";
    ...
    inline const std::string to_string(error_t e)
    {
        ...
        case error_t::success:
            return "success";
        case error_t::wrong_dimension:
            return "wrong_dimension";
        case error_t::wrong_ptype:
            return "wrong_ptype";
        case error_t::operation_not_supported:
            return "operation_not_supported";
        case error_t::wrong_matrix_ordering_format:
            return "wrong_matrix_ordering_format";
        case error_t::wrong_dtype:
            return "wrong_dtype";
        case error_t::wrong_exec_type:
            return "wrong_exec_type";
        default:
            return "unknown";
        }
    }
