#ifndef MINI_JIT_INSTRUCTIONS_SIMD_FP_FSUB_H
#define MINI_JIT_INSTRUCTIONS_SIMD_FP_FSUB_H
...
namespace mini_jit
{
    namespace instructions
    {
        ...
        {
            /**
             * @brief Generates an FSUB (vector) instruction.
             *
             ...
             * @return instruction.
             **/
            constexpr uint32_t fsubVec(simd_fp_t  reg_dest,
                                       simd_fp_t  reg_src1,
                                       simd_fp_t  reg_src2,
                                       arr_spec_t arr_spec)
            {
            ...
            /**
             * @brief Generates an FSUB (scalar) instruction.
             *
             * @param reg_dest destination register.
             * @param reg_src1 first source register.
             * @param reg_src2 second source register.
             ...
             * @return instruction.
             **/
            constexpr uint32_t fsubScalar(simd_fp_t        reg_dest,
                                          simd_fp_t        reg_src1,
                                          simd_fp_t        reg_src2,
...
#endif // MINI_JIT_INSTRUCTIONS_SIMD_FP_FSUB_H