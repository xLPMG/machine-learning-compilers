#ifndef MINI_JIT_INSTRUCTIONS_SIMD_FP_FRINTN_H
#define MINI_JIT_INSTRUCTIONS_SIMD_FP_FRINTN_H
...
namespace mini_jit
{
    namespace instructions
    {
        ...
        {
            /**
             * @brief Generates an FRINTN (vector) instruction.
             *
             ...
             * @return instruction.
             **/
            constexpr uint32_t frintnVec(simd_fp_t  reg_dest,
                                         simd_fp_t  reg_src,
                                         arr_spec_t arr_spec)
            {
            ...
            /**
             * @brief Generates an FRINTN (scalar) instruction.
             *
             * @param reg_dest destination register.
             * @param reg_src source register.
             ...
             * @return instruction.
             **/
            constexpr uint32_t frintnScalar(simd_fp_t        reg_dest,
                                            simd_fp_t        reg_src,
...
#endif // MINI_JIT_INSTRUCTIONS_SIMD_FP_FRINTN_H