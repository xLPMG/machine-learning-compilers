#ifndef MINI_JIT_INSTRUCTIONS_SIMD_FP_FCVTMS_H
#define MINI_JIT_INSTRUCTIONS_SIMD_FP_FCVTMS_H
...
namespace mini_jit
{
    namespace instructions
    {
        ...
        {
            /**
             * @brief Generates an FCVTMS (vector) instruction.
             *
             ...
             * @return instruction.
             **/
            constexpr uint32_t fcvtmsVec(simd_fp_t  reg_dest,
                                         simd_fp_t  reg_src1,
                                         arr_spec_t arr_spec)
            {
            ...
            /**
             * @brief Generates an FCVTMS (scalar SIMD&FP) instruction.
             *
             * @param reg_dest destination register.
             ...
             * @return instruction.
             **/
            constexpr uint32_t fcvtmsScalar(simd_fp_t        reg_dest,
                                            simd_fp_t        reg_src1,
...
#endif // MINI_JIT_INSTRUCTIONS_SIMD_FP_FCVTMS_H