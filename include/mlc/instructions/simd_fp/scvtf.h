#ifndef MINI_JIT_INSTRUCTIONS_SIMD_FP_SCVTF_H
#define MINI_JIT_INSTRUCTIONS_SIMD_FP_SCVTF_H
...
namespace mini_jit
{
    namespace instructions
    {
        ...
        {
            /**
             * @brief Generates an SCVTF (vector) instruction.
             *
             ...
             * @return instruction.
             **/
            constexpr uint32_t scvtfVec(simd_fp_t  reg_dest,
                                        simd_fp_t  reg_src1,
                                        arr_spec_t arr_spec)
            {
            ...
            /**
             * @brief Generates an SCVTF (scalar, fixed point) instruction.
             *
             * @param reg_dest destination register.
             ...
             * @return instruction.
             **/
            constexpr uint32_t scvtfBaseScalar(simd_fp_t        reg_dest,
                                               gpr_t            reg_src1,
            ...
            /**
             * @brief Generates an SCVTF (scalar SIMD&FP) instruction.
             *
             * @param reg_dest destination register.
             * @param reg_src1 first source register.
             * @param size_spec size specifier.
             ...
             * @return instruction.
             **/
            constexpr uint32_t scvtfScalar(simd_fp_t        reg_dest,
                                           simd_fp_t        reg_src1,
                                           neon_size_spec_t size_spec)
            {
                if (size_spec != neon_size_spec_t::s &&
...
#endif // MINI_JIT_INSTRUCTIONS_SIMD_FP_SCVTF_H